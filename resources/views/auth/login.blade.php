...
<div class="absolute left-[640px] top-0 w-[900px] h-full pl-[260px] bg-white transition-transform duration-[1.2s] ease-in-out">
    ...
    <!-- Sign In Form -->
    <div class="form sign-in absolute w-[640px] h-full transition-transform duration-[1.2s] ease-in-out p-[50px_30px_0]">
        <h2 class="w-full text-[26px] text-center">Welcome</h2>
        ...
        <p class="forgot-pass mt-[15px] text-center text-[12px] text-[#cfcfcf]">Forgot password?</p>
        <button type="button" class="submit block mx-auto w-[260px] h-[36px] rounded-[30px] bg-[#d4af7a] text-white text-[15px] uppercase cursor-pointer mt-[40px] mb-[20px]">Sign In</button>
    </div>
</div>
