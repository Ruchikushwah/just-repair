    ...
    <div class="container mx-auto py-12 px-20 mt-16">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div class="flex flex-col">
                <div>
                    <h1 class="text-3xl font-semibold text-gray-800 mb-2">What you Looking For?</h1>
                ...
                <div class="grid grid-cols-2 md:grid-cols-2 gap-6 mt-8">
                    ...
                    <a href="{{ url('/service/' . $service->id) }}" class="block w-full">
                        ...
                        <div class="flex flex-col items-center bg-slate-100  rounded-lg p-4 border border-[#535C91] ">
                            <!-- Service Icon -->
