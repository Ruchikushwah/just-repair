    ...
    <div class="border border-slate-200 p-8 rounded-xl">
        ...
        <div class="grid grid-cols-2 gap-6 border-t border-gray-300 pt-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <span class="px-3 py-1 rounded-lg bg-green-500 text-white font-semibold">{{ $appointment->requirement->requirement}}</span>
            </div>
            ...
            <div class="mt-6 border-t border-gray-300 pt-4">
                <label for="status" class="block text-lg font-medium text-gray-700">Current Status</label>
                <div class="flex items-center space-x-4 mt-2">
                    <span class="px-3 py-1 rounded-lg bg-gray-200 text-gray-700 font-semibold">
                        {{ $appointment->status }}
                    </span>
                </div>
            </div>
        ...
        <div class="mt-6 border-t border-gray-300 pt-4">
            ...
            <div class="flex items-center space-x-4 mt-2">
                <!-- Current status in the select dropdown -->
                ...
                <!-- Update button to change the status -->
