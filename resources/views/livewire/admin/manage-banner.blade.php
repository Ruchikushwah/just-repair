<div class="w-full flex gap-8 bg-white px-10 py-8 rounded-lg mx-auto">
    ...
    <!-- Banner Upload Form -->
    <div class="w-4/12 h-[380px] px-6 py-8 border-teal-600 border rounded-lg bg-white mt-10">
    ...
    <div class="w-8/12 overflow-x-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white border rounded-lg overflow-hidden max-w-xs w-full">
                ...
                <img src="{{ asset('storage/' . $banner->image) }}" class="w-full h-60 p-2 object-cover" />
                <div class="p-6">
                    <div class="flex justify-between items-center mt-4">
                        ...
                        <a href="#"  wire:confirm ="Are you sure you want to delete this?" wire:click="deleteBanner({{ $banner->id }})" class="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700">Delete</a>
                    </div>
                </div>
            </div>
            @endforeach
